...
<div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
            <h2>Administrar <b>Soluciones</b></h2>
          </div>
          <div class="col-sm-6">
            <a href="#addUsserModal" class="btn btn-success" data-toggle="modal"><i class="fa fa-user-plus"></i> <span>Agregar Soluciones</span></a>
          </div>
                </div>
            </div>
      <div class='col-sm-4 pull-right'>
        <div id="custom-search-input">
                            <div class="input-group col-md-12">
                                <form action="buscar_solucion.php" method="get" class="form_search">
 ...
 <table id="datatable-buttons" class="table table-striped table-bordered">
    ...
    if (empty($busqueda)) {
        header('Location: lista_solucion.php');
    }
        ?>  
                          <?php

                             $query=mysqli_query($con,"SELECT mreporte.descripcion,mreporte.fecha_hora,msolucion.solucion,msolucion.fechahora FROM msolucion INNER JOIN mreporte on mreporte.id_reporte = msolucion.id_mreporte where(mreporte.descripcion LIKE '%$busqueda%' OR msolucion.solucion LIKE '%$busqueda%')  ORDER BY mreporte.fecha_hora ASC");
              ...
              ?>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <center>
                           <a class="link_edit" href="editar_usuario.php?idus=<?php echo $data["idusuario"];?>">
                            <i class="far fa-edit" style="color: #1CE70B; "></i> </a>
                            
                        <a class="link_delete" href="eliminar_confirmar_usuario.php?idus=<?php echo $data["idusuario"];?>">| <i class="far fa-trash-alt" style="color: red"></i> </a>
