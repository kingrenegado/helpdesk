...
<html lang="en">
  <head>
    ...
    <title>Ventana Administrador (<?php 
...
<div class="right_col" role="main">
 ...
 <div class="col-md-3 col-sm-7 col-xs-6 tile_stats_count">
              ...
              <div class="count red"><?php 
                 $sql="SELECT * FROM mreporte";
                  $result = mysqli_query($con,$sql);
                  $camp = mysqli_num_rows($result);
                  //$sql2 = mysqli_query($con,"SELECT * FROM msolucion INNER JOIN mreporte on mreporte. where mreporte.id_reporte = msolucion.id_mreporte");
                  $sql2 = mysqli_query($con,"SELECT * FROM msolucion");
                  $camp1 = mysqli_num_rows($sql2);
                  echo $camp-$camp1;
                ?> </div>
