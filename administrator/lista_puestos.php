    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
            <h2> <i class="fas fa-book-open"></i> Administrar <b>Puestos</b></h2>
          </div>
          <div class="col-sm-6">
            <a href="#addpuestoModal" class="btn btn-success" data-toggle="modal"><i class="fas fa-search-plus"></i> <span>Agregar Puesto</span></a>
          </div>
                </div>
            </div>
 ...
 <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                         ...
                         <?php
              $query=mysqli_query($con,"SELECT * FROM cpuesto where status=1  ORDER BY id_cpuesto ASC ");
              ...
              ?>
                      ...
                      <tbody>
                        <tr>
                          <td><?php echo $data['id_cpuesto'];?></td>
                          <td><?php echo $data['puesto'];?></td>
                         
                          <td>
                            <center>
                        <a class="link_delete" href="eliminar_confirmar_puesto.php?id_cpuesto=<?php echo $data["id_cpuesto"];?>"> <i class="far fa-trash-alt" style="color: red"></i> </a>
...
<?php include "modal_add_puesto.php"?>
                <footer>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
