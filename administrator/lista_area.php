    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
            <h2> <i class="fas fa-book-open"></i> Administrar <b>Áreas</b></h2>
          </div>
          <div class="col-sm-6">
            <a href="#addareaModal" class="btn btn-success" data-toggle="modal"><i class="fas fa-search-plus"></i> <span>Agregar Área</span></a>
          </div>
                </div>
            </div>
 ...
 <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                         ...
                         <?php
              $query=mysqli_query($con,"SELECT * FROM carea where status=1 ORDER BY id_carea ASC ");
              ...
              ?>
                      ...
                      <tbody>
                        <tr>
                          <td><?php echo $data['id_carea'];?></td>
                          <td><?php echo $data['area'];?></td>
                         
                          <td>
                            <center>
                        <a class="link_delete" href="eliminar_confirmar_area.php?id_carea=<?php echo $data["id_carea"];?>"> <i class="far fa-trash-alt" style="color: red"></i> </a>
...
<?php include "modal_add_area.php"?>
                <footer>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
