...
include '../php/conexion.php';
  if (!empty($_REQUEST['idreporte'])) {
      ...
      $idreporte = $_REQUEST['id_reporte'];


$idreporte = $_REQUEST['id_reporte'];
     
//$query_reporte = mysqli_query($con,"SELECT mreporte.id_reporte,mreporte.descripcion,mreporte.fecha_hora FROm mreporte where id_reporte='$idreporte' and  status=1 ");
...
<div class="form-register">
        <h1><i class="far fa-building"></i>  Añadir Solución Temporal</h1>
    <div class="alert"><?php echo isset($alert) ? $alert:''; ?></div>

    <form action="agg_soluciontemp.php" method="post">
    <label for="reporto">¿Quién reportó?</label>
    <input type="text" name="reporto" id="reporto" value="<?php echo $nombre?>" readonly style="cursor: no-drop">
    ...
    <textarea name="reporte" readonly rows="4" cols="50" value="" style="width: 350px;border: 1px solid #85929e;border-radius: 5px; cursor: no-drop"><?php echo $descripcion;mysqli_error($con);?></textarea>
    ...
    <label for="descripcion">Porque no se a solucionado aun</label>
    <textarea name="descripcion" rows="5" cols="50" style="width: 350px;border: 1px solid #85929e;border-radius: 5px;" > </textarea>
    
    </select>
    <center>
      <a href="lista_reportes.php" class="btn btn-warning" style="text-align: center; margin-top: 20px;"><i class="fas fa-ban"></i> Cancelar</a>
      </center>
      <button type="submit" class="btn_save" ><i class="fas fa-key"></i> Cerrar Solucion Temporal</button>
    </form>
        </div>
