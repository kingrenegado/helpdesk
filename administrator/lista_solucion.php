 ...
 <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                         ...
                         <?php
              $query=mysqli_query($con,"SELECT msolucion.id_msolucion,mreporte.descripcion,mreporte.fecha_hora,msolucion.solucion,msolucion.fechahora FROM msolucion INNER JOIN mreporte on mreporte.id_reporte = msolucion.id_mreporte where msolucion.status = 1 ORDER BY fechahora ASC");
