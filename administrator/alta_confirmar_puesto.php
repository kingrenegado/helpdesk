...
$query_delete = mysqli_query($con,"UPDATE cpuesto SET status=1 WHERE id_cpuesto=$id_cpuesto");

if ($query_delete) {
 echo '<script type="text/javascript">
        alert("Puesto Dado de alta");
        window.location.href="lista_puestos.php";
        </script>';
}else{
  echo '<script type="text/javascript">
        alert("No se puede volver a dar de alta el Puesto....");
...
<div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
   ...
   <div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
          ...
          <br />
          <center>
               <h1 style="color: green"><i class="fas fa-user-check"></i>  Esta seguro de Volver a dar de alta el Puesto</h1>
