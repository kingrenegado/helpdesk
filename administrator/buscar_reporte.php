   ...
   <div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
    ...
    <div class="container">
        <div class="table-wrapper">
          ...
          <div class="col-sm-6">
            <a href="#addUsserModal" class="btn btn-success" data-toggle="modal"><i class="fa fa-user-plus"></i> <span>Agregar reporte</span></a>
          </div>
                </div>
            </div>
      ...
      <div class='clearfix'></div>
         <a class="btn btn-info" href="exportar/list_reports.php"><i class="far fa-file-excel"></i> 
            Exportar a Excel
          </a>
      <hr>
 ...
 <table id="datatable-buttons" class="table table-striped table-bordered">
    ...
    if (empty($busqueda)) {
        ...
        ?>  
              ...
              $query=mysqli_query($con,"SELECT mreporte.status,musuario.id_carea,carea.id_carea,carea.area,creportes.reporte,mreporte.id_reporte,mreporte.descripcion,mreporte.fecha_hora,musuario.nombre,mreporte.status FROM mreporte INNER JOIN creportes on creportes.idcreporte = mreporte.idcreporte INNER JOIN musuario on musuario.idusuario = mreporte.idusuario
INNER JOIN carea on carea.id_carea = musuario.id_carea WHERE
                                                                (nombre LIKE '%$busqueda%' OR
                                                                descripcion LIKE '%$busqueda%' OR
                                                                area LIKE '%$busqueda%'  and mreporte.status != 0
                                                                )
 ...
 if ($result > 0) {
             ...
             $texto = "Reporte Abierto";
              ...
              ?>
                      ...
                      <tbody>
                        <tr><td><?php echo $data['id_reporte'];?></td>
                          ...
                          <td>
                            <center>
                          <a href="anadir_solucion.php?idreporte=<?php echo $data["id_reporte"];?>"  ><button type="submit" name="accion" class="btn btn-success"><i class="fas fa-check-square"></i></button></a>
                           <a href="anadir_soluciontemp.php?idreporte=<?php echo $data["id_reporte"];?>"  ><button type="submit" name="accion" class="btn btn-warning"><i class="far fa-clock"></i></button></a>
                          </center>
                          </td>
                        </tr>
                      </tbody>
