...
<link rel="stylesheet" type="text/css" href="css/custom.css">
 <link rel="icon" href="images/logo.ico" type="image/ico" />
    <title>Solucionados Temporalmente (<?php 
...
<div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
            <h2><i class="fas fa-poll"></i> Administrar <b>Reportes Solucionados Temporalmente</b></h2>
          </div>
          <div class="col-sm-6">
            <a href="#addsolucionModal" class="btn btn-success" data-toggle="modal"><i class="fas fa-plus-circle"></i> <span>Agregar Solucion</span></a>
          </div>
                </div>
            </div>
      ...
      <div class='clearfix'></div>
       <a class="btn btn-info" href="exportar/lis_reports_soluc_temp.php"><i class="far fa-file-excel"></i> 
            Exportar a Excel
          </a>
      <hr>
 ...
 <table id="datatable-buttons" class="table table-striped table-bordered">
              ...
              INNER JOIN musuario on musuario.idusuario = mreporte.idusuario ORDER BY fechahora ASC ");

              $result = mysqli_num_rows($query);

              if ($result > 0) {
              while($data = mysqli_fetch_array($query)){
                $campo_largo = $data['soluciontemp']; 
              ...
              ?>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <center>
                        <a class="link_delete" href="soluc_buena.php?idreporte=<?php echo $data["id_reporte"];?>"> <i class="fas fa-check" style="color: #12EE1C"></i> </a>
                          <a href="add_soluc_temp.php?idreporte=<?php echo $data["id_reporte"];?>"  ><button type="submit" name="accion" class="btn btn-warning"><i class="far fa-clock" style="color: yellow"></i></button></a>
                          </center>
                          </td>
                        </tr>
                      </tbody>
