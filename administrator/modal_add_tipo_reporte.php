...
<form name="add_reporte" id="add_reporte" method="post" action="add_tipo_reporte.php">
...
<div class="form-group">
    <div class="form-group">
<label style="color: blue">Tipo de reporte</label>
<br/>
<input type="text" name="tiporeporte" class="form-control">
</div>
</div>
</div>
