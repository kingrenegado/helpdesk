...
<div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
   ...
   <div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
    ...
    <div class="container">
      ...
      <div class='col-sm-4 pull-right'>
        <div id="custom-search-input">
                            <div class="input-group col-md-12">
                                <form action="buscar_usuario_baja.php" method="get" class="form_search">
      ...
      <div class='clearfix'></div>
       <a class="btn btn-info" href="exportar/list_users_baja.php"><i class="far fa-file-excel"></i> 
            Exportar a Excel
          </a>
      <hr>
 ...
 <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                         ...
                         <?php
              $query=mysqli_query($con,"SELECT musuario.idusuario,musuario.nombre,musuario.nomusuario,musuario.password,area,puesto,musuario.correo FROM musuario INNER JOIN carea ON musuario.id_carea = carea.id_carea INNER JOIN cpuesto ON musuario.id_cpuesto = cpuesto.id_cpuesto WHERE musuario.status = 0 ORDER BY musuario.nombre ASC");
              ...
              ?>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                           <a class="link_delete" href="alta_confirmar_usuario.php?id=<?php echo $data["idusuario"];?>" style="color: green" ><i class="fas fa-upload" style="color: green"></i>Dar de alta </a>
                          </center>
                          </td>
                        </tr>
                      </tbody>
