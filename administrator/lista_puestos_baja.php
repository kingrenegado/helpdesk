...
<link rel="stylesheet" type="text/css" href="css/custom.css">
 <link rel="icon" href="images/logo.ico" type="image/ico" />
    <title>Lista de Puestos Eliminados (<?php 
 ...
 <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                         ...
                         <?php
              $query=mysqli_query($con,"SELECT * from cpuesto WHERE status = 0 ORDER BY cpuesto.id_cpuesto ASC");
              ...
              ?>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                           <a class="link_delete" href="alta_confirmar_puesto.php?id_cpuesto=<?php echo $data["id_cpuesto"];?>" style="color: green" ><i class="fas fa-upload" style="color: green"></i>Dar de alta </a>
                          </center>
                          </td>
                        </tr>
                      </tbody>
