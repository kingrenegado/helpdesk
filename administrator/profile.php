           ...
           <div class="clearfix"></div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fas fa-user"></i> Perfil  <small>de Usuario</small></h2>
                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      ...
                      <h3><i class="fas fa-user"></i> Nombre: <?php echo $_SESSION['nombre']?> </h3>

                      <ul class="list-unstyled user_data">
                        <li><i class="fas fa-user-tie"></i> Nombre de Usuario: <?php echo $_SESSION['nomusuario']?>
                        </li>

                        <li>
                          <i class="fa fa-briefcase user-profile-icon"></i> Area: <?php echo $_SESSION['area']?>
                        </li>

                         <li>
                          <i class="fas fa-portrait"></i> Puesto: <?php echo $_SESSION['puesto']?>
                        </li>
                         <li>
                          <i class="fas fa-portrait"></i> Correo: <?php echo $_SESSION['correo']?>
                        </li>
                      </ul>
