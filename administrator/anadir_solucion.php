...
<div class="form-register">
    ...
    <form action="agg_solucion.php" method="post">
...
<input type="hidden" name="correo" id="correo" value="<?php echo $correo?>">
    ...
    <textarea name="solucion" rows="5" cols="50" style="width: 350px;border: 1px solid #85929e;border-radius: 5px;" ></textarea>
    ...
    <label for="tiempo">Tiempo invertido al reporte: </label>
    <input type="number" name="tiempo" >
    <button type="submit" class="btn_save" ><i class="fas fa-key"></i> Cerrar Reporte</button>
  <center>
