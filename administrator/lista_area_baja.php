...
<link rel="stylesheet" type="text/css" href="css/custom.css">
 <link rel="icon" href="images/logo.ico" type="image/ico" />
    <title>Lista de Áreas Eliminadas (<?php 
 ...
 <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                         ...
                         <?php
              $query=mysqli_query($con,"SELECT * from carea WHERE status = 0 ORDER BY carea.id_carea ASC");
              ...
              ?>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                           <a class="link_delete" href="alta_confirmar_area.php?id_carea=<?php echo $data["id_carea"];?>" style="color: green" ><i class="fas fa-upload" style="color: green"></i>Dar de alta </a>
                          </center>
                          </td>
                        </tr>
                      </tbody>
