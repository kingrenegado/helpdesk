...
$query_delete = mysqli_query($con,"UPDATE carea SET status=1 WHERE id_carea=$id_carea");

if ($query_delete) {
 echo '<script type="text/javascript">
        alert("Área Dada de alta");
        window.location.href="lista_area.php";
        </script>';
}else{
  echo '<script type="text/javascript">
        alert("No se puede volver a dar de alta el Área....");
...
<div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
   ...
   <div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
          ...
          <br />
          <center>
               <h1 style="color: green"><i class="fas fa-user-check"></i>  Esta seguro de Volver a dar de alta el Área</h1>
