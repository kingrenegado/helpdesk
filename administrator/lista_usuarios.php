...
<div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
   ...
   <div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
    ...
    <div class="container">
        <div class="table-wrapper">
          ...
          <div class="col-sm-6">
            <a href="#addUsserModal" class="btn btn-success" data-toggle="modal"><i class="fa fa-user-plus"></i> <span>Agregar nuevo usuario</span></a>
          </div>
                </div>
            </div>
      ...
      <div class='clearfix'></div>
      <a class="btn btn-info" href="exportar/list.php"><i class="far fa-file-excel"></i> 
            Exportar a Excel
          </a>
      <hr>
 ...
 <table id="datatable-buttons" class="table table-striped table-bordered">
              ...
              $query=mysqli_query($con,"SELECT cusuario.id_cusuario,musuario.idusuario,musuario.nombre,musuario.nomusuario,musuario.password,area,puesto,musuario.correo FROM musuario INNER JOIN cusuario on cusuario.id_cusuario = musuario.id_cusuario  INNER JOIN carea ON musuario.id_carea = carea.id_carea INNER JOIN cpuesto ON musuario.id_cpuesto = cpuesto.id_cpuesto WHERE musuario.status = 1 ORDER BY musuario.nombre ASC");
              ...
              ?>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <center>
                           <a class="link_delete" href="editar_usuario.php?id=<?php echo $data["idusuario"];?>" style="color: green" ><i class="fas fa-user-edit" style="color: yellow"></i></a>
                             <a class="link_delete" href="eliminar_confirmar_usuario.php?id=<?php echo $data["idusuario"];?>" style="color: green" ><i class="fas fa-trash" style="color: red"></i></a>
                          </center>
                          </td>
                        </tr>
                      </tbody>
