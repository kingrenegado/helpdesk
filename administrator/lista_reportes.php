                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?php echo $texto;?></td>
                           <td>
                            <center>
                          <a href="anadir_solucion.php?id_reporte=<?php echo $data["id_reporte"];?>"  ><button type="submit" name="accion" class="btn btn-success"><i class="fas fa-check-square"></i></button></a>
                           <a href="anadir_soluciontemp.php?id_reporte=<?php echo $data["id_reporte"];?>"  ><button type="submit" name="accion" class="btn btn-warning"><i class="far fa-clock"></i></button></a>
                          </center>
                          </td>
                         </tr>
                      </tbody>
