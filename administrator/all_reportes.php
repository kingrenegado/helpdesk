...
INNER JOIN carea on carea.id_carea = musuario.id_carea
 ORDER BY mreporte.id_reporte ASC");
              ...
              while($data = mysqli_fetch_array($query)){
               $status="";
                ...
                if ($data['status']==1) {
                  $status = '<p style="color:#E7401D;text-align:center;align:center;justify-content:center;">Reporte abierto <i class="fas fa-times-circle"></i></p>';
                }elseif ($data['status']==0) {
                  $status = '<p style="color:green;text-align:center;">Reporte cerrado <i class="fas fa-check"></i></p>';
                }elseif ($data['status']==2) {
                  $status= '<p style="color:#135DCF;text-align:center;">Reporte con solución temporal <i class="fas fa-check"></i></p>';
                }elseif ($data['status']==3) {
                  $status= '<p style="text-align:center; color:red">Esperando confirmacion<i class="fas fa-clock" style="color:yellow"></i> </p>';                }
