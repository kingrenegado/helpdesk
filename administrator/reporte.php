...
<div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
 ...
 <table id="datatable-buttons" class="table table-striped table-bordered">
              ...
              $query=mysqli_query($con,"SELECT creportes.reporte,mreporte.id_reporte,mreporte.descripcion,mreporte.fecha_hora,musuario.nombre,mreporte.status,msolucion.solucion,msolucion.fechahora,musuario.correo FROM mreporte INNER JOIN creportes on creportes.idcreporte = mreporte.idcreporte INNER JOIN musuario on musuario.idusuario = mreporte.idusuario
              INNER JOIN msolucion on msolucion.id_mreporte =mreporte.id_reporte  where musuario.nombre= '$nombre' or mreporte.status=3 ORDER BY mreporte.id_reporte ASC ");
              ...
              while($data = mysqli_fetch_array($query)){
                ...
                if ($data['status'] ==3) {
                     $status= "Esperando tu confirmacion";
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?php echo $data['nombre'];?>
                             ...
                             <td>
                            <center>
                          <a href="confirm_solution.php?idreporte=<?php echo $data["id_reporte"];?>"  ><button type="submit" name="accion" class="btn btn-success"><i class="fas fa-check-square"></i></button></a>
 <form action="action3.php" method="post">
                          <input type="hidden" name="correo" value="<?php echo $correo?>">
                          <input type="hidden" name="usuario" value="<?php echo $nombre?>">
                          <input type="hidden" name="id_reporte" value="<?php echo $id_reporte?>">
                          <input type="hidden" name="reporte" value="<?php echo $descripcion?>">
                          <input type="hidden" name="solucion" value="<?php echo$solucion?>">
                          <a href="enviar_confirmacion.php?idreporte=<?php echo $data["id_reporte"]; echo $data["correo"];echo $data["nombre"];?>"><button type="submit" name="accion" class="btn btn-danger"><i class="far fa-envelope"></i></button></a></a>
                          </form>
                          </center>
                          </td>
                          </td>
