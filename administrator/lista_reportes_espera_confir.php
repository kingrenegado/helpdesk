    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
            <h2> <i class="fas fa-book-open"></i> Esperando Confirmación de <b>Reportes</b></h2>
          </div>
          <div class="col-sm-6">
      ...
      <div class='clearfix'></div>
        <a class="btn btn-info" href="exportar/list_reports_wait_confirm.php"><i class="far fa-file-excel"></i> 
            Exportar a Excel
          </a>
      <hr>
