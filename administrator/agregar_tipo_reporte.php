...
<link rel="stylesheet" type="text/css" href="css/custom.css">
    ...
    <title>Lista tipos de Reportes (<?php 
...
<div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
   ...
   <div class="container">
        <div class="table-wrapper">
          ...
          <div class="col-sm-6">
            <a href="#addreporteModal" class="btn btn-success" data-toggle="modal"><i class="fas fa-search-plus"></i> <span>Agregar Tipo de Reporte</span></a>
          </div>
                </div>
            </div>
      <div class='col-sm-4 pull-right'>
        <div id="custom-search-input">
                            <div class="input-group col-md-12">
                                <form action="buscar_treporte.php" method="get" class="form_search">
 ...
 <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                         ...
                         <?php
              $query=mysqli_query($con,"SELECT * FROM creportes ORDER BY idcreporte ASC ");
              ...
              ?>
                      ...
                      <tbody>
                        <tr>
                          <td><?php echo $data['idcreporte'];?></td>
                          <td><?php echo $data['reporte'];?></td>
                         
                          <td>
                            <center>
                        <a class="link_delete" href="eliminar_confirmar_tiporep.php?idrep=<?php echo $data["idcreporte"];?>"> <i class="far fa-trash-alt" style="color: red"></i> </a>
...
<?php include "modal_add_tipo_reporte.php"?>
