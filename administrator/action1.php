...
try {
    ...
    $mail->Subject = 'Tiene una solucion temporal su reporte por parte de: '." ".$usuario;
    $mail->Body = '<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css" integrity="sha384-50oBUHEmvpQ+1lW4y57PTFmhCaXp0ML5d60M1M7uH2+nqUivzIebhndOJK28anvf" crossorigin="anonymous">'.'Descripción del reporte: '.$reporte.'<br/>'.'Solución temporal del reporte: '.$descripcion.'<br/>'.'<label style="color:red;"><i class="fas fa-exclamation-circle"></i> No se olvide de dar seguimiento a sus reportes en Help Desk</label>' ;
