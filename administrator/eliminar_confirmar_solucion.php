...
$id=$_POST['id_msolucion'];
$query_delete = mysqli_query($con,"UPDATE msolucion SET status=0 WHERE id_reporte=$id");

if ($query_delete) {
 echo '<script type="text/javascript">
        alert("Solución Eliminado");
        window.location.href="lista_solucion.php";
        </script>';
}else{
  echo '<script type="text/javascript">
...
}if (empty($_REQUEST['id'])) 
    {
        ...
        $idsolucion = $_REQUEST['id'];

        $query= mysqli_query($con,"SELECT msolucion.id_msolucion,mreporte.descripcion,mreporte.fecha_hora,msolucion.solucion,msolucion.fechahora FROM msolucion INNER JOIN mreporte on mreporte.id_reporte = msolucion.id_mreporte where id_msolucion = '$idsolucion' ");
...
<div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
   ...
   <div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
          ...
          <br />
          <center>
               <h1 style="color: red"><i class="fas fa-trash"></i>  Esta seguro de Eliminar la Solución</h1>
            <p>Descripción del reporte: <span><?php echo $descripcion ?></span></p>
           <p>Fecha del reporte: <span><?php echo $fecha?></span>  </p>
            <p>Descripción de la solución: <span><?php echo $solucion?></span>  </p>
            <p>Fecha de la solución: <span><?php echo $fecha_sol?></span>  </p>
