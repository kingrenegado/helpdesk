    ...
    if (empty($busqueda)) {
        ...
        ?>  
                          <?php
                             ...
                             $query=mysqli_query($con,"SELECT musuario.idusuario,musuario.nombre,musuario.nomusuario,musuario.password,carea.area,cpuesto.puesto,musuario.correo FROM musuario INNER JOIN carea ON carea.id_carea = musuario.id_carea INNER JOIN cpuesto ON cpuesto.id_cpuesto = musuario.id_cpuesto  WHERE
