...
if (!empty($_POST)) 
{
  ...
  $query_delete = mysqli_query($con,"UPDATE carea set status = 0 where id_carea = $id");
echo $query_delete;
...
}if (empty($_REQUEST['id_carea'])) {
  # code...
   
       echo mysqli_error($con);
}else{

  $id_carea = $_REQUEST['id_carea'];

  $query = mysqli_query($con,"SELECT * from carea WHERE id_carea = $id_carea ");
...
<div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
   ...
   <div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
          ...
          <br />
          <center>
               <h1 style="color: red"><i class="fas fa-eraser"></i>  Esta seguro de Eliminar el Área</h1>
          
            <p>Area: <span><?php echo $area?></span>  </p>
               <form method="post" action="">
               <input type="hidden" name="id_carea" value="<?php echo $id_carea;?>">
                <a href="lista_area.php" class="btn btn-info"><i class="fas fa-ban"></i>Cancelar</a>
