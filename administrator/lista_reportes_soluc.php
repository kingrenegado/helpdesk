...
<link rel="stylesheet" type="text/css" href="css/custom.css">
 <link rel="icon" href="images/logo.ico" type="image/ico" />
    <title>Lista de Reportes Solucionados (<?php 
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
            <h2><i class="fas fa-poll"></i> Administrar <b>Reportes Solucionados</b></h2>
          </div>
          <div class="col-sm-6">
            <a href="#addsolucionModal" class="btn btn-success" data-toggle="modal"><i class="fas fa-plus-circle"></i> <span>Agregar Solución</span></a>
          </div>
                </div>
            </div>
      ...
      <div class='clearfix'></div>
        <a class="btn btn-info" href="exportar/list_reports_soluc.php"><i class="far fa-file-excel"></i> 
            Exportar a Excel
          </a>
      <hr>
