...
<label style="color: blue">Selecciona tu nombre:</label><div class="form-group">
    <?php
        ...
        $query_usuario=mysqli_query($con,"SELECT * FROM musuario where musuario.nombre = '$nombre'  ORDER BY nombre");
...
<label style="color: blue">Tipo de Reporte:</label><div class="form-group">
    <?php
    ...
    ?>
  <select name="reporte" id="reporte" class="form-control" style="color: blue" required>
    <?php 
...
<label style="color: blue">Descripción del reporte</label>
<br/>
<textarea name="descripcion" cols="20" rows="4"  class="form-control"  required>   </textarea>
</div>
</div>
</div>
