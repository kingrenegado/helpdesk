...
<html class="no-js" lang="en">
 ...
 <table id="datatable-buttons" class="table table-striped table-bordered">
              ...
              INNER JOIN msolucion on msolucion.id_mreporte =mreporte.id_reporte  where mreporte.status=3 and musuario.nombre ='$nombre'  ORDER BY mreporte.id_reporte ASC ");
