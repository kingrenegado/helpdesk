			...
			<div class="container">      
				...
				<div class="collapse navbar-collapse" id="navbar-menu">
					<ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fas fa-male"></i> <?php echo $_SESSION['nombre'];?> </a>
								<ul class="dropdown-menu animated fadeOutUp" style="display: none; opacity: 1;">
		...
		<section class="features">
			...
			<div class="container">
				...
				<div class="col-md-2 col-sm-4">
					...
					<div class="features-content">
						<span class="box1"><span aria-hidden="true"><i class="fas fa-users"></i></span></span>
						<h3>Lista de usuarios</h3>
						<p>En este apartado podrá ver la lista de los usuarios, así como añadir usuarios y editar.</p>
					</div>
					</a>
				</div>
