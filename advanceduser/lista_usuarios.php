...
<html class="no-js" lang="en">
 ...
 <table id="datatable-buttons" class="table table-striped table-bordered">
              ...
              $query=mysqli_query($con,"SELECT cusuario.id_cusuario,musuario.nombre,musuario.nomusuario,musuario.idusuario,musuario.password,carea.area,cpuesto.puesto,musuario.correo FROM musuario INNER JOIN cusuario on cusuario.id_cusuario = musuario.id_cusuario INNER JOIN carea on carea.id_carea = musuario.id_carea INNER JOIN cpuesto on cpuesto.id_cpuesto = musuario.id_cpuesto WHERE musuario.status = 1 ORDER BY musuario.nombre ASC");
